...
public class NumberToWords {
    ...
    public static void numberToWords(int number) {
        ...
        StringBuffer numberToStringBuffer = new StringBuffer(Integer.toString(number));
        numberToStringBuffer = numberToStringBuffer.reverse();

        String numberToString = numberToStringBuffer.toString();

        int num = Integer.parseInt(numberToString);
    ...
    public static int getDigitCount(int num) {
        if(num<0) return -1;
        return new String(Integer.toString(num)).length();
    }
